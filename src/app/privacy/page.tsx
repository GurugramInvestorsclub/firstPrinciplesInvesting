                ...
                <div className="container max-w-4xl px-4 md:px-8 mx-auto">
                    ...
                    <div className="prose prose-neutral dark:prose-invert max-w-none">
                        ...
                        <ul className="list-disc pl-6 space-y-2 mb-6">
                            <li><strong>Personal Information:</strong> Name, email address, and phone number when you register for events or contact us.</li>
                        ...
                        <p className="mb-6">
                            If you have any questions about this Privacy Policy, please contact us at: <a href="mailto:hello@firstprinciples.in" className="text-primary hover:underline">hello@firstprinciples.in</a>
                        </p>
                    </div>
                </div>
            </main>
