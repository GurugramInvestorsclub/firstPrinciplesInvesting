    ...
    <div style={{ minHeight: "100vh", background: "var(--bg-deep, #0a0a0a)", color: "#fff", padding: "40px 24px" }}>
      <div style={{ maxWidth: "900px", margin: "0 auto" }}>
        ...
        <div style={{ marginBottom: "24px" }}>
          ...
          >
            <ArrowLeft style={{ width: "16px", height: "16px" }} /> Back to Subscribers Forum
          </Link>
        </div>
        ...
        {!loading && authorized === false && (
          <div style={{ background: "rgba(26, 26, 26, 0.8)", border: "1px solid rgba(16, 185, 129, 0.3)", borderRadius: "16px", padding: "48px 32px", textAlign: "center" }}>
            ...
            <h2 style={{ fontSize: "22px", fontWeight: 700, color: "#fff", margin: "0 0 12px 0" }}>
              Subscriber Membership Required
            </h2>
            <p style={{ color: "rgba(255, 255, 255, 0.7)", fontSize: "14px", maxWidth: "480px", margin: "0 auto 24px" }}>
              This topic discussion is reserved for active FPI Insights subscribers.
            </p>
            <Link
              href="/membership"
              style={{ display: "inline-flex", padding: "12px 24px", borderRadius: "8px", background: "#10b981", color: "#000", fontWeight: 700, textDecoration: "none" }}
            >
        ...
        {!loading && authorized === true && topic && (
          <div style={{ display: "flex", flexDirection: "column", gap: "28px" }}>
            {/* Topic Main Card */}
            <div style={{ background: "rgba(26, 26, 26, 0.8)", border: "1px solid rgba(255,255,255,0.1)", borderRadius: "16px", padding: "32px" }}>
              <div style={{ display: "flex", alignItems: "center", gap: "12px", marginBottom: "16px" }}>
                <span style={{ fontSize: "12px", padding: "3px 8px", borderRadius: "6px", background: "rgba(16, 185, 129, 0.15)", color: "#10b981", fontWeight: 700 }}>
                  SUBSCRIBERS FORUM
                </span>
                {topic.isLocked && (
              ...
              <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", borderBottom: "1px solid rgba(255,255,255,0.08)", paddingBottom: "16px", marginBottom: "20px", fontSize: "13px", color: "rgba(255,255,255,0.6)" }}>
                <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
                  <div style={{ width: "32px", height: "32px", borderRadius: "50%", background: "rgba(255,255,255,0.1)", color: "#fff", display: "flex", alignItems: "center", justifyContent: "center", fontWeight: 700 }}>
            ...
            {!topic.isLocked && (
              <div style={{ background: "rgba(26, 26, 26, 0.8)", border: "1px solid rgba(255,255,255,0.1)", borderRadius: "16px", padding: "24px" }}>
                ...
                <form onSubmit={handlePostReply}>
                  <textarea
                    rows={4}
                    placeholder="Write your response or analysis..."
                    value={replyContent}
                    ...
                    <div key={post.id} style={{ background: "rgba(26, 26, 26, 0.8)", border: "1px solid rgba(255,255,255,0.08)", borderRadius: "12px", padding: "20px" }}>
                      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "12px", fontSize: "13px" }}>
                        <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
                          <div style={{ width: "26px", height: "26px", borderRadius: "50%", background: "rgba(16, 185, 129, 0.2)", color: "#10b981", display: "flex", alignItems: "center", justifyContent: "center", fontWeight: 700, fontSize: "12px" }}>
