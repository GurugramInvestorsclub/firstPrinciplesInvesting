...
export function Hero() {
    return (
        <section className="relative w-full py-24 md:py-32 lg:py-48 flex flex-col items-center justify-center text-center px-4 overflow-hidden bg-bg-deep">
            ...
            <div className="space-y-8 max-w-5xl mx-auto z-10 relative flex flex-col items-center">
                {/* Pill Badge */}
                <div className="inline-flex items-center rounded-full px-4 py-1.5 text-xs font-medium transition-all duration-300 cursor-default
                    bg-bg-primary/50 backdrop-blur-sm border border-gray-500/20 text-gold shadow-sm hover:border-gold/40 hover:shadow-[0_0_15px_rgba(245,184,0,0.1)] animate-fade-in opacity-0">
                ...
                {/* Main Headline */}
                <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold tracking-tight text-white leading-[1.05] drop-shadow-sm animate-fade-in-up delay-100 opacity-0">
                    Invest with Conviction. <br className="hidden md:block" />
                    <span className="text-gold inline-block">Built on First Principles.</span>
                </h1>

                {/* Subtext */}
                <p className="text-base md:text-lg text-gray-300 max-w-prose mx-auto leading-[1.7] font-normal animate-fade-in-up delay-200 opacity-0 relative">
                ...
                <div className="flex flex-wrap items-center justify-center gap-2 md:gap-4 text-xs md:text-sm text-gray-400/80 animate-fade-in-up delay-300 opacity-0">
                ...
                {/* CTAs */}
                <div className="flex flex-col items-center gap-3 pt-6 animate-fade-in-up delay-300 opacity-0 w-full">
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-5 w-full sm:w-auto">
                        ...
                        <Button asChild variant="outline" size="lg" className="rounded-full px-10 h-14 text-lg font-medium border-gray-500/30 text-white bg-transparent hover:bg-white/5 hover:border-gray-500/60 transition-all duration-300">
                            <Link href="/insights">
                                Read Our Insights
                            </Link>
                        </Button>
                    ...
                    {/* Microcopy */}
                    <p className="text-[10px] uppercase tracking-widest text-gray-400/60 font-medium mt-2">
