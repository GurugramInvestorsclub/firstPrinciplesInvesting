...
export function MembersOnlyView({ onSelectReport }: MembersOnlyViewProps) {
    ...
    const categories = ["All", ...Array.from(new Set(mockReports.filter(r => r.access === "subscriber").map(r => r.industry)))]
